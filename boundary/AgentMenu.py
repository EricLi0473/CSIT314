...
"}")
    ...
    def retranslateUi(self, AgentMenu):
        ...
        self.TitleLabel_4.setText(_translate("AgentMenu", "Favorites"))
        ...
        self.btn_profile2.setText(_translate("AgentMenu", "Profile"))
        self.btn_favorites2.setText(_translate("AgentMenu", "Favorites"))
