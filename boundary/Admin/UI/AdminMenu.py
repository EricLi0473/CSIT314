...
class Ui_AdminMenu(object):
    def setupUi(self, AdminMenu):
        ...
        AdminMenu.resize(1099, 763)
        AdminMenu.setMinimumSize(QtCore.QSize(120, 0))
...
"}")
        ...
        self.btn_nav_bar.setMinimumSize(QtCore.QSize(0, 0))
...
"}")
        ...
        self.label_8 = QtWidgets.QLabel(self.header_widget)
        font = QtGui.QFont()
        ...
        self.label_8.setStyleSheet("color: rgb(255, 77, 61);")
        ...
        self.btn_log_out.setIcon(icon6)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.TableWidget1, 5, 0, 1, 2)
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.page_profile)
        ...
        self.gridLayout_3.addWidget(self.RoundListWidget, 4, 0, 1, 1)
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.btn_addProfile1 = FilledPushButton(self.page_profile)
        self.btn_addProfile1.setMinimumSize(QtCore.QSize(150, 0))
        self.btn_addProfile1.setObjectName("btn_addProfile1")
        self.horizontalLayout_6.addWidget(self.btn_addProfile1)
        self.SearchLineEdit_2 = SearchLineEdit(self.page_profile)
...
"}")
    ...
    def retranslateUi(self, AdminMenu):
        ...
        self.label_8.setText(_translate("AdminMenu", "Admin Menu"))
        ...
        self.SearchLineEdit.setPlaceholderText(_translate("AdminMenu", "search a username"))
        ...
        self.label.setText(_translate("AdminMenu", "User Management terminal"))
        self.label_6.setText(_translate("AdminMenu", "Profile Management terminal"))
        self.btn_addProfile1.setText(_translate("AdminMenu", "Add Profile"))
        self.SearchLineEdit_2.setPlaceholderText(_translate("AdminMenu", "search a profile"))
        self.label_7.setText(_translate("AdminMenu", "Welcome to user Profile page"))
...
from qfluentwidgets import SearchLineEdit, TableWidget, TitleLabel
