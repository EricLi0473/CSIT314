...
# Form implementation generated from reading ui file 'AdminMenu_Dialog_UpdatedProfile.ui'
#
...
class Ui_Dialog_UpdateProfile(object):
    def setupUi(self, Dialog_UpdateProfile):
        Dialog_UpdateProfile.setObjectName("Dialog_UpdateProfile")
        Dialog_UpdateProfile.resize(346, 199)
        Dialog_UpdateProfile.setStyleSheet("background-color: rgb(245, 250, 254);")
        self.gridLayout = QtWidgets.QGridLayout(Dialog_UpdateProfile)
        self.gridLayout.setObjectName("gridLayout")
        self.label_profile = QtWidgets.QLabel(Dialog_UpdateProfile)
        font = QtGui.QFont()
        ...
        self.LineEdit_profile = LineEdit(Dialog_UpdateProfile)
...
"")
        ...
        self.PushButton_create = FilledPushButton(Dialog_UpdateProfile)
...
"}")
        ...
        self.PushButton_cancel = PushButton(Dialog_UpdateProfile)
        self.PushButton_cancel.setObjectName("PushButton_cancel")
        self.horizontalLayout.addWidget(self.PushButton_cancel)
        self.gridLayout.addLayout(self.horizontalLayout, 4, 0, 1, 1)

        self.retranslateUi(Dialog_UpdateProfile)
        self.PushButton_cancel.clicked.connect(Dialog_UpdateProfile.close) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(Dialog_UpdateProfile)

    def retranslateUi(self, Dialog_UpdateProfile):
