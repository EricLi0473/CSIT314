...
"}")
        ...
        self.btn_search_user.setMinimumSize(QtCore.QSize(120, 0))
...
"}")
        ...
        self.gridLayout_3.addWidget(self.btn_addProfile1, 2, 0, 1, 1)
        ...
        self.btn_search_profile = PushButton(self.page_profile)
        self.btn_search_profile.setObjectName("btn_search_profile")
        self.horizontalLayout_6.addWidget(self.btn_search_profile)
...
"}")
    ...
    def retranslateUi(self, AdminMenu):
        ...
        self.btn_search_user.setText(_translate("AdminMenu", "search"))
        ...
        self.btn_search_profile.setText(_translate("AdminMenu", "Push button"))
...
from qfluentwidgets import ComboBox, LineEdit, PushButton, SearchLineEdit, TableWidget, TitleLabel
